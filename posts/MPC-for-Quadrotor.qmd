...
\text{s.t.} \quad 
& x_1 = x_{\text{IC}} \\ 
& x_{i+1} = f(\bar{x}_i, \bar{u}_i) + \bigg[\frac{\partial f}{\partial x} \bigg|_{\bar{x}_i, \bar{u}_i}  \bigg](x_i - \bar{x}_i) + \bigg[\frac{\partial f}{\partial u} \bigg|_{\bar{x}_i, \bar{u}_i}  \bigg](u_i - \bar{u}_i)   \quad \text{for } i = 1,2,\ldots,N-1 \\ 
